  ...
  return (
    <div className={`min-h-screen bg-background`}>
      ...
      <footer className="bg-primary text-primary-foreground py-16">
        ...
        <div className="text-center text-sm text-primary-foreground/60 mt-6 flex items-center justify-center gap-1">
          {t("footer.madeWith")}
          <svg
          ...
          {t("footer.by")} <span className="font-medium">Basil Aljarrah</span>
        </div>
      </footer>
    </div>
  );
